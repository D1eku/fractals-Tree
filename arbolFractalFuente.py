...
#Fuente: https://www.academia.edu/4266396/Creando_arboles_fractales_con_Turtle_en_Python
...
PROF = 8 #cantidad de niveles en el árbol (más de 10 puede durarmucho dibujándose)
...
#Funcion que inicializa la posicion de la tortuga e invoca a la funcion 
#de dibujar arbol fractal
def init():
	turtle.speed(0)
